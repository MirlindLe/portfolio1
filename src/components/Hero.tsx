...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="h-[100vh] flex items-center justify-center relative py-12"
    >
      {/* Two Column Layout */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <Card className="w-full max-w-md bg-card/95 dark:bg-card/90 backdrop-blur-md border-2 dark:border-primary/20 shadow-2xl dark:shadow-primary/10">
              <CardContent className="p-6">
                ...
                <div className="flex gap-3 pt-4 border-t">
                  <Button
                    variant="outline"
                    className="flex-1 font-medium py-2.5 hover:bg-primary"
                    asChild
                  >
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mb-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 animate-fade-in animation-delay-200">
                Mirlind Leku
              </h1>
            ...
            {/* Description */}
            <p className="text-base md:text-lg text-muted-foreground mb-8 leading-relaxed animate-fade-in animation-delay-600">
